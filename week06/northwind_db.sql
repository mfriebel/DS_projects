...
CREATE TABLE public.orders (
    ...
    shipregion character varying(30),
    shippostalcode character varying(10),
    shipcountry character varying(30)
);
...
CREATE TABLE public.products (
    ...
    categoryid integer NOT NULL,
    quantityperunit character varying(50),
    unitprice real,
    unitinstock integer,
...
CREATE TABLE public.regions (
    ...
    regiondescription character varying(20)
);
...
--
-- Name: shippers_shipperid_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: shippers_shipperid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.territories (
    ...
    territorydescription character varying(30),
    regionid integer
);
...
--
-- Name: regions regionid; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: shippers shipperid; Type: DEFAULT; Schema: public; Owner: -
--
...
5	Buchanan	Steven	Sales Manager	Mr.	1955-03-04 00:00:00	1993-10-17 00:00:00	14 Garrett Hill	London	\N	SW1 8JR	UK	(71) 555-4848	3453	\\x30	Steven Buchanan graduated from St. Andrews University in Scotland with a BSC degree in 1976.  Upon joining the company as a sales representative in 1992 he spent 6 months in an orientation program at the Seattle office.	2	http://accweb/emmployees/buchanan.bmp
...
COPY public.products (productid, productname, supplierid, categoryid, quantityperunit, unitprice, unitinstock, unitsonorder, reorderlevel, discontinued) FROM stdin;
...
--
-- Name: regions_regionid_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: shippers_shipperid_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: regions regions_regionid_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: suppliers suppliers_supplierid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.suppliers
    ADD CONSTRAINT suppliers_supplierid_key UNIQUE (supplierid);
...
--
-- Name: order_details order_details_orderid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: order_details order_details_productid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_details
    ADD CONSTRAINT order_details_productid_fkey FOREIGN KEY (productid) REFERENCES public.products(productid) ON DELETE CASCADE;
...
--
-- Name: orders orders_employeeid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_employeeid_fkey FOREIGN KEY (employeeid) REFERENCES public.employees(employeeid) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_supplierid_fkey FOREIGN KEY (supplierid) REFERENCES public.suppliers(supplierid) ON DELETE CASCADE;


--
-- Name: territories territories_regionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
